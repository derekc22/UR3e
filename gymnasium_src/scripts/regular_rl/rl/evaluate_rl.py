...
def run_trained_rl_policy(policy_fpath, vecnormalize_fpath):
    """
    Loads and runs a trained RL policy.
    """
...
if __name__ == "__main__":
    ...
    # Define paths
    policy_fpath = f"policies/rl_policies/rl_policy_{action_mode}.zip"
    vecnormalize_fpath = f"policies/rl_policies/rl_vecnormalize_{action_mode}.pkl"
    run_trained_rl_policy(policy_fpath, vecnormalize_fpath)
