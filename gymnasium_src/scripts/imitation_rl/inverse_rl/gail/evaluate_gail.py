...
# def run_trained_gail_policy(policy_path="policies/imitation_rl_policies/gail_policy.zip"):
#     """
...
if __name__ == "__main__":
    ...
    policy_fpath = f"policies/imitation_rl_policies/gail_policy_{agent_mode}.zip"
    run_trained_gail_policy(policy_fpath)