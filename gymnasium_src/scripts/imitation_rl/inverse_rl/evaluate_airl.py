...
if __name__ == "__main__":
    ...
    # Define paths
    policy_fpath = f"policies/imitation_rl_policies/airl_policy_{action_mode}.zip"
    vecnormalize_fpath = f"policies/imitation_rl_policies/airl_vecnormalize_{action_mode}.pkl"
