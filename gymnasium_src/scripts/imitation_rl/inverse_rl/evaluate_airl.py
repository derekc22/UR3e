...
def run_trained_airl_policy(policy_fpath, vecnormalize_fpath):
    """
    Loads and runs a trained AIRL policy.
    """
...
if __name__ == "__main__":
    ...
    # Define paths
    policy_fpath = f"policies/imitation_rl_policies/airl_policy_{imitation_mode}.zip"
    vecnormalize_fpath = f"policies/imitation_rl_policies/airl_vecnormalize_{imitation_mode}.pkl"
    
    run_trained_airl_policy(policy_fpath, vecnormalize_fpath)
