...
def train_airl(expert_trajs):
    ...
    policy_fpath = f"{save_dir}/airl_policy_{action_mode}.zip"
    reward_net_path = f"{save_dir}/airl_reward_net_{action_mode}.pt"
    vecnormalize_fpath = f"{save_dir}/airl_vecnormalize_{action_mode}.pkl"
