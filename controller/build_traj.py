...
#     # Save to CSV
#     df.to_csv("controller/data/traj.csv", index=False)
#     print(f"Generated smooth trajectory with {num_points} points saved to traj.csv")
